...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img class="first-slide" src="/resources/dist/img/photo1.png"
				alt="First slide">
			<div class="container">
		...
		<div class="item">
			<img class="second-slide" src="/resources/dist/img/photo2.png"
				alt="Second slide">
			<div class="container">
				<div class="carousel-caption">
...
<div class="container marketing">
	...
	<div class="row">
		<div class="col-lg-4">
			<img class="img-circle" src="/resources/dist/img/avatar5.png"
		...
		<!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img class="img-circle" src="/resources/dist/img/avatar2.png"
				alt="Generic placeholder image" width="140" height="140">
			<h2>Heading</h2>
		...
		<!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img class="img-circle" src="/resources/dist/img/avatar04.png"
				alt="Generic placeholder image" width="140" height="140">
			<h2>Heading</h2>
